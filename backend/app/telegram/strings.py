...
STRINGS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "btn_another": "🆕 Next new one",
        "btn_understood": "✅ I understood this",
        "btn_understood_done": "✅ Understood — won't show again",
        "toast_understood": "Got it. This one won't come back.",
        "toast_understood_undone": "Back in the rotation.",
        "btn_open": "📖 Open in Curio",
        "btn_open_app": "📖 Open Curio",
        "btn_search_app": "🔎 Search in Curio",
        "btn_surprise": "🆕 What's new",
    ...
    "ru": {
        ...
        "btn_another": "🆕 Ещё новое",
        "btn_understood": "✅ Я понял это",
        "btn_understood_done": "✅ Понято — больше не покажем",
        "toast_understood": "Понятно. Эта карточка больше не вернётся.",
        "toast_understood_undone": "Вернули в ротацию.",
        "btn_open": "📖 Открыть в Curio",
        "btn_open_app": "📖 Открыть Curio",
        "btn_search_app": "🔎 Искать в Curio",
        "btn_surprise": "🆕 Что нового",
